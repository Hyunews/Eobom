...
import { getSttStatus, transcribeAudio, storeVoiceAudio } from '../controllers/sttController';
...
router.post('/store-audio', storeVoiceAudio); // 06-05 §8 D-3 — Web Speech 성공 시 원본만 저장
