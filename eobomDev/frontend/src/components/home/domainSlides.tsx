...
export const domainSlides: Record<string, DomainSlide> = {
  ...
  'care-guide': {
    ...
    badgeIcon: <ChecklistShieldIcon size={20} color="var(--state-ok-fg)" />,
    badgeColor: 'var(--state-ok-fg)',
    badgeBg: 'var(--state-ok-bg)',
    titleLine1: '갑작스러운 이별 앞에서도',
    titleLine2: '빠짐없이 챙겨드립니다',
    highlightColor: '#5B7065',
    description: '사망 후 꼭 해야 할 행정절차 타임라인과 모바일 부고장 작성을 한 곳에서 확인하세요.',
    bullets: [
      '사망진단서·사망신고 등 22개 행정절차를 체크리스트로 확인',
      '정부24 안심상속 원스톱 서비스로 고인의 금융·토지·세금 내역 한 번에 조회',
      '상속포기·한정승인 등 되돌릴 수 없는 항목을 1순위로 우선 안내',
    ],
    featureIcon: <ChecklistShieldIcon size={36} color="var(--state-ok-fg)" />,
    featureIconBg: 'var(--state-ok-bg)',
    featureBorderColor: '#5B7065',
    featureTitle: '행정절차 타임라인 & 부고장',
    featureDesc: '사망신고·상속포기 등 법정기한이 있는 절차를 순서대로 안내하고, 모바일 부고장 작성을 도와드립니다.',
  ...
  obituary: {
    ...
    tab: 'obituary',
    badgeLabel: '모바일 부고장',
    badgeIcon: <MessageSquare size={20} color="var(--state-ok-fg)" />,
    badgeColor: 'var(--state-ok-fg)',
    badgeBg: 'var(--state-ok-bg)',
    ...
    featureIcon: <MessageSquare size={36} color="var(--state-ok-fg)" />,
    featureIconBg: 'var(--state-ok-bg)',
    featureBorderColor: '#5B7065',
