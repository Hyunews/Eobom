...
>
> 왜 갈랐나: 현행본이 690KB까지 커져 게이트가 매번 133건을 훑었다.
> 근거 → `.harness/_meta/크레딧_소모_실측_260902.md`. 2026-09-02 분리.
> 🔵 `harness-doctor.sh` #8(판정 분포)은 **현행 + 아카이브를 합쳐** 센다 — 옮겼다고 통계가 줄지 않는다.
>
...
### 보완 및 기획 반영 결과
- [`docs/02_전문가_매칭/02-01_전문가상담_도메인_상업화_및_구체화_명세서.md`](../../02_전문가_매칭/02-01_전문가상담_도메인_상업화_및_구체화_명세서.md) 및 [`reports/02_전문가_매칭/02-01_이어봄_전문가상담_도메인_상업화_보고서.html`](../../../reports/02_전문가_매칭/02-01_이어봄_전문가상담_도메인_상업화_보고서.html) 갱정 완료:
...
### 보완 및 기획 반영 결과
- [`docs/01_장사시설_매칭/01-02_공공데이터_및_API_상업적_이용_법률_검토서.md`](../../01_장사시설_매칭/01-02_공공데이터_및_API_상업적_이용_법률_검토서.md) 문서를 **2단계 법률 검토 체계(Dual-Layer Framework)**로 대폭 보완 갱신:
