    ...
    <div className="container">
        ...
        <div style={{
          ...
          <div style={{ padding: '3rem 2.5rem' }}>
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: '1.5rem' }}>
              <strong>K-Ending 서비스</strong>는 생전의 웰다잉 준비(엔딩노트, 상속)부터 임종 직후의 장례·묘지 매칭, 그리고 사후 디지털 유품 정리와 행정 원스톱 가이드까지 단일 플랫폼에서 완결하는 한국형 디지털 엔딩 정보 서비스입니다.
            </p>
            <div style={{ display: 'flex', gap: '1.5rem', fontSize: '0.95rem', color: 'var(--primary-color)', fontWeight: 600 }}>
              <span>✓ 24시간 365일 긴급 지원</span>
              <span>✓ AES-256 개인 보안 금고</span>
          ...
          <div style={{
            ...
            <img 
              src="/hero_visual.png" 
              alt="K-Ending 웰다잉 토탈 케어 서비스 비주얼" 
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'cover',
      ...
      <div className="grid">
        <div className="card" style={{ borderTop: '5px solid var(--primary-color)' }}>
          <div className="card-title"><ShieldCheck color="var(--primary-color)" /> 1. 장례·묘지 맞춤 비교</div>
        ...
        <div className="card" style={{ borderTop: '5px solid var(--point-color)' }}>
          <div className="card-title" style={{ color: 'var(--point-color)' }}><Scale color="var(--point-color)" /> 2. 상속·법률·세무 상담</div>
          <div className="card-content">
            <p>변호사/세무사 1:1 비대면 화상상담, 월별 상담 일정 달력 예약 및 상속세·증여세 자동 시뮬레이터</p>
          </div>
        </div>
        <div className="card" style={{ borderTop: '5px solid var(--primary-light)' }}>
          <div className="card-title" style={{ color: 'var(--primary-light)' }}><PackageCheck color="var(--primary-light)" /> 3. 디지털 유품 정리</div>
          <div className="card-content">
            <p>고인 SNS/클라우드 계정 정산 신청, 지역 기반 현물 유품 수거 업체 및 온라인 디지털 추모관 갤러리</p>
          </div>
        </div>
        <div className="card" style={{ borderTop: '5px solid #D9534F' }}>
          <div className="card-title" style={{ color: '#D9534F' }}><ScrollText color="#D9534F" /> 4. 디지털 엔딩노트</div>
          <div className="card-content">
            <p>사전 연명의료 의향서, 자산/비밀번호 AES-256 개인 보안 금고 및 사후 지정 수신 유언 메시지</p>
          </div>
        </div>
        <div className="card" style={{ borderTop: '5px solid #F0AD4E' }}>
          <div className="card-title" style={{ color: '#B47318' }}><CalendarHeart color="#B47318" /> 5. 상중 케어·행정 가이드</div>
          <div className="card-content">
