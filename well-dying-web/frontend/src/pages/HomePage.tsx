      ...
      >
        ...
        >
          <div style={{ maxWidth: '1200px', width: '100%', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            ...
            <div style={{ backgroundColor: '#FFFFFF', padding: '2.5rem', borderRadius: '24px', boxShadow: '0 12px 35px rgba(26,43,76,0.08)', border: '2px solid #5B7065' }}>
              <div style={{ width: '64px', height: '64px', backgroundColor: '#F1F5F9', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
        ...
        >
          <div style={{ maxWidth: '1200px', width: '100%', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            ...
            <div style={{ backgroundColor: '#FFFFFF', padding: '2.5rem', borderRadius: '24px', boxShadow: '0 12px 35px rgba(212,163,89,0.12)', border: '2px solid #D4A359' }}>
              <div style={{ width: '64px', height: '64px', backgroundColor: '#FEF3C7', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
        ...
        >
          <div style={{ maxWidth: '1200px', width: '100%', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#FFFFFF', padding: '0.4rem 1rem', borderRadius: '20px', fontSize: '0.85rem', color: '#1A2B4C', fontWeight: 800, marginBottom: '1.2rem', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                <NoteKeyIcon size={20} color="#1A2B4C" /> 04. 디지털 엔딩노트
              </div>
              <h2 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#1A2B4C', fontFamily: "'KoPub World Batang', serif", marginBottom: '1.2rem', lineHeight: 1.25 }}>
                사랑하는 이들에게 남기는<br />
            ...
            <div style={{ backgroundColor: '#FFFFFF', padding: '2.5rem', borderRadius: '24px', boxShadow: '0 12px 35px rgba(26,43,76,0.08)', border: '2px solid #D4A359' }}>
              <div style={{ width: '64px', height: '64px', backgroundColor: '#FEF3C7', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
          ...
          <div style={{ maxWidth: '1200px', width: '100%', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#DEF7EC', padding: '0.4rem 1rem', borderRadius: '20px', fontSize: '0.85rem', color: '#03543F', fontWeight: 800, marginBottom: '1.2rem' }}>
                <ChecklistShieldIcon size={20} color="#03543F" /> 05. 상중 · 행정 케어
              </div>
              <h2 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#1A2B4C', fontFamily: "'KoPub World Batang', serif", marginBottom: '1.2rem', lineHeight: 1.25 }}>
                갑작스러운 이별 앞에서도<br />
            ...
            <div style={{ backgroundColor: '#FFFFFF', padding: '2.5rem', borderRadius: '24px', boxShadow: '0 12px 35px rgba(91,112,101,0.12)', border: '2px solid #5B7065' }}>
              <div style={{ width: '64px', height: '64px', backgroundColor: '#DEF7EC', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
        ...
        {/* ========================================================= */}
        {/* [섹션 6] 에필로그 & 라운드 푸터 카드 (Footer Snap Section) */}
        {/* ========================================================= */}
        <section
          style={{
            width: '100%',
          ...
          <div style={{ maxWidth: '1200px', width: '100%', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div
              style={{
                ...
                borderRadius: '24px',
                padding: '2rem 2.5rem',
                boxShadow: '0 10px 30px rgba(26,43,76,0.06)',
                border: '1px solid #DFDCD7',
                display: 'flex',
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '0.8rem', flexWrap: 'wrap' }}>
                <button
                  onClick={() => setActiveTab?.('ending-note')}
                  className="btn"
                  style={{ backgroundColor: '#5B7065', color: '#FFFFFF', padding: '0.75rem 1.4rem', borderRadius: '12px', fontSize: '0.9rem', fontWeight: 700, border: 'none' }}
                >
                  사전 엔딩노트 작성 ➔
                </button>
                <button
                  onClick={() => setActiveTab?.('facility')}
                  className="btn"
                  style={{ backgroundColor: '#1A2B4C', color: '#FFFFFF', padding: '0.75rem 1.4rem', borderRadius: '12px', fontSize: '0.9rem', fontWeight: 700, border: 'none' }}
                >
                  전국 시설 탐색 ➔
                </button>
              </div>
