...
**2. [Sonnet] ① 엔딩노트 "한눈에 보기" 모달**(핸드오프 완료) → **② `07-04` A·B단계**(제목
6곳 통일 + ⭐강조 + `07-02` §3.1 배너). ⏸ `06-04` Phase 3은 사망확인 확정 전까지 미충족.

**3. [Gemini] 게이트 대기 6건**(wt 79~84). 🔴 wt(83) 편차 — 가족 조회 API가
...
+ doctor §10 · **`07-04` 신설**. 🟡 로컬 dev DB 편지 2건·가족 지정 2건 삭제 — 재등록 필요.
