...
🆕**`00-39`디자인기준(09-18)**—`00-09`·`00-29`·`00-38`**대체**.**그룹별진행**(§9):①목록=care-guide
시안+구현✅(인라인0·사이드바→헤더드롭다운·tsc·build통과·🔴실기동대기·편차=wt말미)→
🔴다음=나머지4개(facility등)적용·②폼(obituary)③읽기④랜딩⑤홈=대표시안.
🟡height:36px3곳=보류.
