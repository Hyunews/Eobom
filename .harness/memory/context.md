...
🔴 **`00-13`§4.5·`07-03` 갱신 필요**(09-07 wt135) — 부고장 개설이 추모관을 더는 강제 생성
안 함(체크박스 선택제로 뒤집힘, DB 마이그레이션 완료). 상세 `walkthrough.md` wt135.
...
✅ `06-05` D-1~D-11+UI다듬기+부고장·추모관분리(wt121~136, DB마이그레이션 포함) 전부
구현·빌드통과—상세 `walkthrough.md`. 🔴 #24 보류(`backlog.md`⑪). 🟡 미검증(dev한계):
`--confirm`·운영버킷2단계. ▶ 다음=Phase C(§3.3)/backlog.
...
마지막  : 2026-09-07 — 부고장·추모관 분리(wt135, DB마이그레이션)+유언장문구축약(wt136) / wt112·114·115 대기
```
