...
🆕 **비용 0 확인 2건**(전화·페이지) **+ 04 명칭 확정** → `04-03` §6·§4.
...
🆕🔴 **`EndingNotePage.tsx:185` 비밀번호 placeholder 제거 — 1줄·선행조건 없음**(`04-03` §5-7·§7).

**3. [Gemini] 게이트 대기 10건**(wt 79~88 · 🔴 편차 2건 = wt(83)·wt(86), 사람 확인 필요).
