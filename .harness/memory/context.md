...
✅②`obituary`·mypage M-1.5·M-2·M-3구현완료(09-21·쓰기경로✅검증·§4.3-1가드없음확인·커밋대기).✅파기배치④·`00-27`§9.2철회API코드완료(09-21·tsc통과·**미실행**—dry-run·백업·승인대기).🔴**Opus결정**:추모관보유회원=Memorial.createdByUserId RESTRICT FK로파기불가→보류처리중.
