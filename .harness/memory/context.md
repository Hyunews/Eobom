...
✅ `00-38` Phase1·1.5·2①Farewell 완료 · wt174편차 3건 **전부 통과**(§8.1-1 ⓖ, DoD#8=픽셀동결 아님).
🔴 **새 구멍 2개**: §4.5-2 `0.9`/`0.95rem` fontSize **140곳**(→`--fs-body`, **DoD#2 미통과**)·
§4.5-3 타입토큰이 간격에 **132곳**(→`--sp-4`/`--sp-3`).
▶ **다음=Phase1.6 C→D**(순서고정) →②`CareGuide`→③`EndingNote`→`00-37`A-3.
