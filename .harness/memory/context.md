...
✅ **08-27** [Sonnet] walkthrough 79~83(엔딩노트 Phase 1·2) · [Opus] `00-06` SCR-016·017 ·
`00-20` 확정 5건 · **`db-safety.md` 신설**. 🟡 `00-19`·`00-21`은 활성 기간 확정 후.
🟡 로컬 dev DB 편지 2건·가족 지정 2건 삭제 — 재등록 필요.
