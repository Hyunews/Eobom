...
✅ **08-27 [Sonnet]** walkthrough 79~83(엔딩노트 Phase 1·2 — `Entry`·`Grant`·아코디언·공개시점
UI·가족 조회 API) · **[Opus]** `00-06` SCR-016·017 · `00-20` 확정 5건(3단위 조치 분리 등).
🟡 `00-19`·`00-21`은 활성 기간 확정 후 한 번에. 🟡 dev DB 테스트 편지 2건·가족 지정 2건 로컬
삭제 사고(claude_tasks 22) — 재등록 필요.
...
- 🟡 **harness-doctor 예산 근접**(`roles.md` 9/10KB·`systems.md` 11/12KB, 둘 다 🟢) — 닿으면
  올리기 전에 *"이 파일에 있을 게 맞나"* 부터(`AGENTS.md` §9).
