...
**1. ✅[Sonnet] 엔딩노트 ④~⑧⑩ 신설+⑨개명 + 드롭다운 폭 축소**(08-27, walkthrough 80~81,
80은 사용자가 커밋함) — 7개 섹션 UI(미저장), ⑨"유언장 초안" 개명+확인버튼 제거, `.container`
안 select를 좁혀 데스크톱 2열/모바일 1열. 🟡 dev DB 테스트 편지 2건 남음(배치 정리 대상).
...
**4. [Gemini] 게이트 대기 3건**(walkthrough 79~81, 70~78은 판정 완료). 🔴 나머지 실기동 미검증.

✅ **08-27 완료**(walkthrough 79~81) — 모바일 인트로 배너 수정 · 엔딩노트 섹션 확장+⑨개명
+보관함 저장 간소화 · ⑩ 추가 + 드롭다운 폭 축소.
...
마지막  : 2026-08-25 [Opus] 06-05 도메인분리 + 하네스 결함7건 수정 / 2026-08-27 [Sonnet] walkthrough 70~81
```
...
- 🔴 **06 백엔드 — 보관함(`FarewellMessage`)만 배선됨**(08-26). 엔딩노트 본문 저장
  (`EndingNoteEntry`, 10개 섹션 UI는 있음)·`Grant`·`Log`는 여전히 0건.
