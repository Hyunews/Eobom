...
🆕`04-05`법근거·목업+`04-04`§2.4-1국내도구.🔴04-05§6#6(해지↔상속승인)=A-5합산.
...
🆕**`00-39`(09-18)**—00-09·00-29·00-38대체.①완료(f61c5f4)·§6등재끝.facility=✅색·글자값v2교체+§5폭1048px개정완료(09-22,주석4곳정정,tsc/build통과).
✅memorial→①편입완료(09-22)—MemorialPage.tsx전면재작성(목록=my-obituaries패턴·폼=§6.8·삭제=모달2단계).🔴Opus:00-39§9.1표(465·471·473행)"memorial남음"갱신필요.🔴사람실기동대기(만들기·삭제흐름).
...
✅**그룹② 5/5 전부 완료(09-22~23)**—ending-note(`.v2-accordion-*`신설)·farewell-messages
(`.v2-mail-*`마스터·디테일신설+편지카드그리드auto-fit2열,사람지시)+엔딩노트크로스링크문구
단정→조건문수정.index.css옛`.ending-note-*`·`.farewell-*`합계약765줄삭제.tsc/build매회통과.
