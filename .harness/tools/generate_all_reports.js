...
const REPORT_MAPPINGS = [
  ...
  // 03. 디지털 유품 추모관
  { md: '03_디지털_유품_추모관/03-01_관리자_회원연동_설계_메모.md', html: '03_디지털_유품_추모관/03-01_이어봄_관리자_회원연동_설계_메모.html' },
  { md: '03_디지털_유품_추모관/03-02_디지털_계정_정리_및_온라인_추모관_명세서.md', html: '03_디지털_유품_추모관/03-02_이어봄_디지털_계정_정리_및_온라인_추모관_명세서.html' },
  { md: '03_디지털_유품_추모관/03-03_디지털_유품_추모관_도메인_기획서.md', html: '03_디지털_유품_추모관/03-03_이어봄_디지털_유품_추모관_도메인_기획서.html' },

  // 05. 엔딩노트 유언
  { md: '05_엔딩노트_유언/05-01_관리자_열람범위_설계_메모.md', html: '05_엔딩노트_유언/05-01_이어봄_관리자_열람범위_설계_메모.html' },

  // 06. 비즈니스 분석
  { md: '06_비즈니스_분석/06-01_경쟁_서비스_분석_보고서.md', html: '06_비즈니스_분석/06-01_이어봄_경쟁_서비스_분석_보고서.html' },
];
